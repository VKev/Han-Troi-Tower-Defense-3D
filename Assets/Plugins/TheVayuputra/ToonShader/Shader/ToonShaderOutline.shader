    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(Varyings input) : SV_Target
            {
                ...
                float3 ambient = edge * _EdgeColor.rgb + bakedGI * _BaseColor.rgb * baseMap;
        ...
        // The outline shell is deliberately not represented: it is a view-dependent
        // stylisation, not a real surface the light should bounce off.
        Pass
        {
            Name "Meta"
            Tags { "LightMode"="Meta" }
