...
namespace Technie.PhysicsCreator.Rigid
{
	...
	public class Hull : IHull
	{
		...
		public void GenerateCollisionMesh(Vector3[] meshVertices, int[] meshIndices, Mesh[] autoHulls)
		{
			...
			else if (hull.type == HullType.Face)
			{
				...
				GenerateFace(hull, meshVertices, meshIndices);
			}
		...
		private void GenerateFace(Hull hull, Vector3[] meshVertices, int[] meshIndices)
		{
