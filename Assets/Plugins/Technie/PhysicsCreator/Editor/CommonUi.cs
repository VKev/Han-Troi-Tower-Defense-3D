...
namespace Technie.PhysicsCreator
{
	public class CommonUi
	{
		...
		public const string DEFAULT_INSTALL_PATH = "Assets/Plugins/Technie/PhysicsCreator/";
		...
		// TODO: This can get quite slow with very high poly models, consider caching the results between runs
		// Also consider using Handles.matrix rather than doing the transform manually
		// 
