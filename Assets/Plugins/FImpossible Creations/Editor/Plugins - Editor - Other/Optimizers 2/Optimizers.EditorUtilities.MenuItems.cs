...
namespace FIMSpace.FOptimizing
{
    public static class Optimizers_MenuItems
    {
        ...
        //    CreateScriptAsset("Assets/Plugins/FImpossible Creations/Optimizers/Code/Templates/FLODType_Template.txt", "YourComponentNameHere.cs", fullPath);
        //}
        ...
        static void CreateCustomIFLODScript()
        {
            ...
            CreateScriptAsset("Assets/Plugins/FImpossible Creations/Plugins - Other/Optimizers 2/Code/Templates/IFLOD_Template.txt", "YourComponentNameHere.cs", fullPath);
        }
        ...
        static void CreateCustom2020IFLODScript()
        {
            ...
            CreateScriptAsset("Assets/Plugins/FImpossible Creations/Plugins - Other/Optimizers 2/Code/Templates/IFLOD2020_Template.txt", "YourComponentNameHere.cs", fullPath);
        }
#endif
