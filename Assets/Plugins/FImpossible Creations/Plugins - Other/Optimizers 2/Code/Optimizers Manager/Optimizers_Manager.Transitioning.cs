...
namespace FIMSpace.FOptimizing
{
    public partial class OptimizersManager
    {
        ...
        {
            int optimizerId = optimizer.FGetObjectIDHash(); // Id code for quicker search in list
        ...
        {
            int optimizerId = optimizer.FGetObjectIDHash(); // Hash code for quicker search in list
