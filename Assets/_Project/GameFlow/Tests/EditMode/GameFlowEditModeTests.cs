...
namespace TowerDefense3D.GameFlow.Tests.EditMode
{
    public sealed class GameFlowEditModeTests
    {
        ...
        public void SaveWriteFailure_KeepsRuntimeUnlock_AndAllowsRetry()
        {
            ...
            GameObject owner = new GameObject("Save Coordinator Test");
            SaveCoordinator coordinator = owner.AddComponent<SaveCoordinator>();
            SetPrivateField(coordinator, "repository", repository);
