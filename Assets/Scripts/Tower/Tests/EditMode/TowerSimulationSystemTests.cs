...
{
    public sealed class TowerSimulationSystemTests
    {
        ...
        public void AdvanceFrame_CarriesRemainderBetweenFrames()
        {
            ...
            TowerSimulationSystem system =
                CreateSystem(fixture.Manager);

            int firstFrameTicks =
                system.AdvanceFrame(0.03f);
        ...
        {
            Fixture fixture = CreateRunningFixture();
            TowerSimulationSystem system = CreateSystem(fixture.Manager);

            int executedTicks = system.AdvanceFrame(0.12f);

            Assert.That(executedTicks, Is.EqualTo(2));
            Assert.That(system.AccumulatedSeconds, Is.EqualTo(0.02d).Within(0.000001d));
            Assert.That(system.InterpolationAlpha, Is.EqualTo(0.4f).Within(0.00001f));
        }
        ...
        public void TickCompleted_FiresAfterEveryCaughtUpTick()
        {
            ...
            system.TickCompleted += completedTicks.Add;

            int executedTicks = system.AdvanceFrame(0.16f);
        ...
        [Test]
        public void Reset_ClearsAccumulatedFrameTime()
        {
            Fixture fixture = CreateRunningFixture();
        ...
        private static TowerSimulationSystem CreateSystem(
            TowerNetworkManager manager)
        {
            return new TowerSimulationSystem(manager);
        }
